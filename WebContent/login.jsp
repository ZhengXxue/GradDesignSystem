...
<style>
body{background: #fff url(images/daxue.jpg) 50% 0 no-repeat;margin:0;padding:0;}
...
<body>
<div id="login">
        <div class="logo">毕业设计选题管理系统</div>
        <div class="main">
            <form class="formname" action="loginAction" method="post" onSubmit="return checklogin();">
            <ul>
    ...
    <div class="copyright"><br>毕业设计选题管理系统</div>
</div>
</body>
<%
