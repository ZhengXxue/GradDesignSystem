<%@ page language="java"  contentType="text/html; charset=UTF-8"
 import="com.bean.Student ,com.dao.stuDao,java.util.*" pageEncoding="utf-8"%>
...
<body style="margin: 5px;">
	<table id="dg" title="学生信息" class="easyui-datagrid" fitColumns="true"
	 pagination="true" fit="true" toolbar="#tb">
		<thead>
			<tr>
				<th field="Sname" width="30" align="center">姓名</th>
				<th field="Sno" width="30" align="center">学号</th>
				<th field="Spwd" width="30" align="center">密码</th>
				<th field="Smajor" width="30" align="center">专业</th>
				<th field="Sclass" width="30" align="center">年级</th>
				<th field="Semail" width="30" align="center">邮箱</th>
				<th field="Stel" width="30" align="center">电话</th>
				<th field="GPA" width="30" align="center">绩点</th>
...
%>
				...
				<td align="center"><a href="javascript:openStudentModifyDialog(<%=stu.getSno()%>)" onclick="return window.confirm('是否确定修改？')" class="easyui-linkbutton" iconCls="icon-edit" plain="true">修改</a>
				&emsp;<a href=<%="../stuAction?act=delete&Sno="+stu.getSno()%> onclick="return window.confirm('是否确定删除？')" class="easyui-linkbutton" iconCls="icon-cancel" plain="true">删除</a>
				</td>
		        </tr>
		        <%} %>
	</table>
	<div id="tb">
		<div>
			<a href="javascript:openStudentAddDialog()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">添加</a>
		    <a href="../stuAction?act=reset" class="easyui-linkbutton" iconCls="icon-edit" plain="true">重置密码</a>
		</div>
	</div>
	<div id="dlg" class="easyui-dialog" style="width: 600px;height: 280px;padding: 10px 20px"
		...
		<form id="fm" method="post">
			<table cellspacing="5px;">
				<tr>
					<td>姓名：</td>
					<td><input type="text" name="Sname" id="Sname" class="easyui-validatebox" required="true"/></td>
					<td></td>
					<td>学号：</td>
					<td><input type="text" name="Sno" id="Sno" class="easyui-validatebox" required="true"/></td>
				</tr>
				<tr>
				    <td>密码：</td>
